...
pedidos.data_pedido,
pedidos.status
from clientes join pedidos on clientes.cliente_id = pedidos.cliente_id;
...
select
participacoes_campanha.cliente_id,
clientes.nome,
...
campanhas.data_fim,
participacoes_campanha.data_participacao
from clientes join participacoes_campanha on participacoes_campanha.cliente_id = clientes.cliente_id join campanhas;
...
from pacientes join prontuarios;
